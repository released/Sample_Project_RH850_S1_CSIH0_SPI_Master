...
void R_Config_CSIH0_Create(void)
{
    ...
    CSIH0.CFG1 = _CSIH_USED_BAUDRATE_1 | _CSIH_PARITY_NO | _CSIH_DATA_LENGTH_8 | _CSIH_DATA_DIRECTION_MSB | 
    ...
    CSIH0.CFG2 = _CSIH_USED_BAUDRATE_2 | _CSIH_PARITY_NO | _CSIH_DATA_LENGTH_8 | _CSIH_DATA_DIRECTION_MSB | 
                 _CSIH_PHASE_SELECTION_TYPE4 | _CSIH_IDLE_INSERTED_NOT_ALWAYS | _CSIH_IDLE_TIME_0 | 
                 _CSIH_HOLD_TIME_0 | _CSIH_INTER_DATA_DELAY_TIME_0 | _CSIH_SETUP_TIME_0;
