...
#define _CSIH0_BAUD_RATE_0                             (0x01F4U) /* baudrate set */
#define _CSIH0_BAUD_RATE_1                             (0x0271U) /* baudrate set */
#define _CSIH0_BAUD_RATE_2                             (0x04E2U) /* baudrate set */
#define _CSIH0_BAUD_RATE_3                             (0x0209U) /* baudrate set */
