...
void R_Config_PORT_Create(void)
{
    ...
    PORT.PODC8 = _PORT_PODCn4_PUSH_PULL | _PORT_PODCn5_PUSH_PULL;
    PORT.PODC8 = (uint32_t) ~(_PORT_PODCn4_PUSH_PULL | _PORT_PODCn5_PUSH_PULL);
    PORT.PODC8 = _PORT_PODCn4_PUSH_PULL | _PORT_PODCn5_PUSH_PULL;
    PORT.PBDC8 = _PORT_PBDCn4_MODE_DISABLED | _PORT_PBDCn5_MODE_DISABLED;
    PORT.PU8 = _PORT_PUn0_PULLUP_OFF | _PORT_PUn1_PULLUP_OFF | _PORT_PUn2_PULLUP_ON | _PORT_PUn3_PULLUP_OFF | 
               _PORT_PUn6_PULLUP_OFF | _PORT_PUn7_PULLUP_OFF | _PORT_PUn8_PULLUP_OFF | _PORT_PUn9_PULLUP_OFF | 
               _PORT_PUn10_PULLUP_OFF | _PORT_PUn11_PULLUP_OFF | _PORT_PUn12_PULLUP_OFF;
    PORT.PD8 = _PORT_PDn0_PULLDOWN_OFF | _PORT_PDn1_PULLDOWN_OFF | _PORT_PDn3_PULLDOWN_OFF | _PORT_PDn6_PULLDOWN_OFF | 
    ...
    PORT.P8 = _PORT_Pn4_OUTPUT_LOW | _PORT_Pn5_OUTPUT_LOW;
    PORT.PM8 = _PORT_PM8_DEFAULT_VALUE | _PORT_PMn0_MODE_UNUSED | _PORT_PMn1_MODE_UNUSED | _PORT_PMn2_MODE_UNUSED | 
               _PORT_PMn3_MODE_UNUSED | _PORT_PMn4_MODE_OUTPUT | _PORT_PMn5_MODE_OUTPUT | _PORT_PMn6_MODE_UNUSED | 
               _PORT_PMn7_MODE_UNUSED | _PORT_PMn8_MODE_UNUSED | _PORT_PMn9_MODE_UNUSED | _PORT_PMn10_MODE_UNUSED | 
